...
def alpr():
    # handle the POST request
        ...
        anpr_results = request_data["results"]
        anpr_id = request_data["uuid"]
        anpr_plate = anpr_results[0]
        data_to_return = {"ANPR ID": anpr_id,
                      "Licence plate": anpr_plate["plate"], "Result Confidence": anpr_plate["confidence"]}
...
@app.route("/video")
def video():
    return send_file("./video/alprVideo.mp4")
